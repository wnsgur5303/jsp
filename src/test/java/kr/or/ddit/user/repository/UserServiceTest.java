...
public class UserServiceTest {
   ...
   private UserServiceI userDervice;
   
   @Before
   public void setup() {
      userDervice = new UserService();
      ...
      // 신규 입력 테스트를 위해 테스트 과젱엇 입력된 데이터를 삭제
      userDervice.deleteUser("ddit_n");
		/*
   ...
   public void tearDodwn() {
      userDervice.deleteUser("testUser");
   }
   ...
   public void selectAllUserTest() {
      ...
      /***When***/
      List<UserVo> userList = userDervice.selectAllUser();
   ...
   public void selectUserTest() {
      ...
      /***When***/
      UserVo user   = userDervice.selectUser(userid);
   ...
   public void selectPagingUserTest() {
      ...
      /***When***/
      //List<UserVo> userList = userDervice.selectPagingUser(page, pagesize);
      List<UserVo> userList = userDervice.selectPagingUser(pageVo);
   ...
   public void selectAllUserCntTest() {
      ...
      /***When***/
      int userCnt = userDervice.selectAllUserCnt();
   ...
   public void deleteUserTest() {
      ...
      /***When***/
      int deleteCnt = userDervice.deleteUser(userid);
